...
const byte stabilizer = 1; // Cantidad de muestras antes de devolver una medicion
...
const unsigned long updateTime = 1000*60*60*10; // Lapsos de tiempo para actualizar el GPS [milisegundos]
const unsigned long updateSD = 1000*60*15; // Lapsos de tiempo para actualizar la SD [milisegundos]
const int spear = 60;