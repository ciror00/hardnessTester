...
const unsigned long updateTime = 10; // Lapsos de tiempo para actualizar el GPS [minutos]
const unsigned long updateSD = 5; // Lapsos de tiempo para actualizar la SD [minutos]
const int spear = 60;