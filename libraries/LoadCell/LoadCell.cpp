...
void LoadCell::calibrate(long patternWeight, int samples, byte iteration){
  ...
  layover = readValue / patternWeight; // Se calcula una factor de escala
  MSG("Factor calculado. Apoyo el equipo para terminar la calibracion...\n");
  while(t = 5000){t--;};
  MSG("Terminando calibracion. Espera un momento...\n");
